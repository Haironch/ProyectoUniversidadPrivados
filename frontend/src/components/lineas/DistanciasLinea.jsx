...
const DistanciasLinea = () => {
  ...
  const [vistaActual, setVistaActual] = useState("estaciones");
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="px-6 py-4 bg-indigo-600 text-white">
          ...
          <p className="text-indigo-100 mt-1 text-sm">
            Aquí puedes ver las distancias entre estaciones de cada línea y
            calcular rutas
          </p>
        </div>
        ...
        <div className="p-6">
          ...
          {loading && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mt-4">Calculando...</p>
            </div>
          )}
              ...
              {vistaActual === "matriz" && (
                <div className="overflow-x-auto">
                  <p className="text-sm text-gray-600 mb-4">
                    {matrizDistancias.length} rutas posibles entre estaciones
                  </p>
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                      <tr>
                      ...
                      {matrizDistancias.map((dist, index) => (
                        <tr key={index} className="hover:bg-gray-50">
                          <td className="px-6 py-4">
                            ...
                            <div className="text-sm text-gray-500">
                              {dist.origen.codigo} (#{dist.origen.orden})
                            </div>
                          </td>
                          <td className="px-6 py-4">
                            <div className="text-sm font-medium text-gray-900">
                            ...
                            <div className="text-sm text-gray-500">
                              {dist.destino.codigo} (#{dist.destino.orden})
                            </div>
                          </td>
